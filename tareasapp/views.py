...
# Esta es la logica de toda la aplicaicon
...
# MOSTRAR URL DE DETALLE TAREA CON LA ID DE LA TAREA
# A DETALLAR
...
def editar_tarea(request, id):
    ...
    if request.method == 'POST':
        ...
        # LOS TRUEFALSE SIEMPRE EMPIEZAN EN FALSO
